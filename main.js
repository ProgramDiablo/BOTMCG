//|━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━|
//| Creator : Milkitabotz (penata ulang)
//| Creator: Milkitabotz
...
const vcard = 'BEGIN:VCARD\n' 
            + 'VERSION:3.0\n' 
            + 'FN:Milkitabotz\n' //ganti
            + 'ORG: Creator MilkitaBotz;\n' 
            + 'TEL;type=CELL;type=VOICE;waid=6285654792270:+62 856-5479-2270\n' //ganti
            + 'END:VCARD'
...
/*prefix = `#`*/
botname = 'MilkitaBotz' //ganti jdu name bot Lu:v
blocked = []
fakereply = '© Created By Milkitabotz' //jan di ganti lah, hormati yang buat!!
fake = 'Rizky Gblk' //ganti serah lu
...
async function starts() {
	...
	console.log('>', '[',color('YT DEVELOPER','yellow'),']','MakasarCyberGhost')
    console.log('>', '[',color('IG DEVOLOPER','red'),']','MakasarCyberGhost')
    console.log('>', '[',color('INFO UPDATE?','blue'),']','CEK YT GAN')
    
	client.on('qr', () => {
	console.log(color('[','white'), color('!','red'), color(']','white'), color(' SUB YT MakasarCyberGhost'))
	})
